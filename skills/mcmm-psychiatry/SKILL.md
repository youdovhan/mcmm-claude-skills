...
description: База знань з курсу MCMM "Психіатрія — наука про душу" (Master Class of Mental Medicine, mcmm.creo.ua) + coaching layer для Юрієвих клієнтських сесій. PRIMARY LECTURER Світлана Володимирівна Ісаєнко (Dr. Isaenko, КМН, ХНМУ 2011, @dr_isaenko) для 14/14 теоретичних уроків. INVITED EXPERT Бережний Герман — practicing psychiatrist from Академія лікаря Ісаєнка, провів m10l5 Live Q/A capstone (2h 44min, 10 учасниць). Self-intro L28: "Мене звати Бережний Герман, я лікар-психіатр". CORRECTION: Ісаєнко — тренер організації / Бережний — practicing psychiatrist who delivered Q/A. Використовуй ЗАВЖДИ коли Юрій питає про теми психіатрії з курсу MCMM, історію психіатрії, нозологію, ключові постаті (Пінель, Крепелін, Фройд, Кречмер, Блойлер тощо), парадигми психіатрії, нюанси DSM/МКБ за матеріалом курсу, або просить пройти/перевірити тест по уроках MCMM. ТАКОЖ використовуй проактивно — коли клієнт у сесії описує психіатричний симптом, при підозрі на психотичний регістр у клієнта, коли треба маршрутизувати клієнта до психіатра, при питаннях типу 'це не до мене?' / 'це психіатрія?' про клієнта. Тригери — "MCMM урок N", "психіатрія MCMM", "урок з психіатрії", "тест по психіатрії MCMM", "історія психіатрії", "як Пінель", "що в курсі MCMM про X", "переклади лекцію", "складімо тест", "розкажи з курсу психіатрії", "конспект MCMM", "це психіатрія?", "це не до мене?", "клієнт описує голоси/марення/манію", "red flag у клієнта", "Бережний Герман", "Q/A психіатр", "Академія Ісаєнка", "сертралін", "есциталопрам", "атомоксетин", "бринтелікс", "маніакальна тріада", "raptus felicis", "коли маршрутизувати до психіатра", "РДУГ дебют до 12", "DID", "BPD primary scanning", "RED FLAG істинний суїцид (depression → суddenly улыбатися)", "4 препарати прикриття СІЗЗ", "парадокс СІЗЗ 2-3 тижні".
---
